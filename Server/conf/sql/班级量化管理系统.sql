...
create table if not exists user(
    id         int not null auto_increment primary key comment '对姓名使用md5加密的id',
    name        varchar(32) not null comment '姓名',
    username    varchar(64) not null unique comment '登陆的邮箱' unique,
...
create table if not exists inspect_class(
    id          int         not null auto_increment primary key auto_increment comment 'id',
...
) default charset=utf8 comment '检查项目表';
...
-- 3.2 人员表
insert into user(`name`,`username`,`password`,`is_headdepart`,`is_inspector`,`is_headteacher`,`permission_level`)
values
('邢予','xingyu@qq.com','xingyu321',0,1,1,2),
('吴洁','wujie@qq.com','wujie321',0,1,1,2),
('王钰坤','wangyukun@qq.com','wangyukun321',0,0,1,1),
('陕娟娟','shanjuanjuan@qq.com','shanjuanjuan321',0,1,0,3),
('王璐','wanglu@qq.com','wanglu321',1,1,0,3),
('赵东','zhaodong@qq.com','zhaodong321',1,0,0,3),
('方荣卫','fangrongwei@qq.com','fangrongwei321',1,0,0,3),
('demo','demo@qq.com','demo',0,0,1,4);
...
insert into inspect_result(`cls`,`user_id`,`inspector_id`,`classroom`,`dormitory`,`personal`,`floor`,`discipline`)
  ...
  ("大数据201",4,3,'{"分数":70,"减分项":{"纸屑":10,"黑板":10}}','{"分数":70,"减分项":{"垃圾桶":10,"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ...
  ("大数据201",5,1,'{"分数":77,"减分项":{"纸屑":10,"黑板":13}}','{"分数":80,"减分项":{"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ("大数据201",3,6,'{"分数":85,"减分项":{"纸屑":5,"黑板":10}}','{"分数":70,"减分项":{"垃圾桶":10,"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ...
  ("大数据201",5,3,'{"分数":89,"减分项":{"纸屑":5,"黑板":6}}','{"分数":80,"减分项":{"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ("大数据201",6,6,'{"分数":80,"减分项":{"纸屑":10,"黑板":10}}','{"分数":80,"减分项":{"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ("大数据201",7,6,'{"分数":90,"减分项":{"纸屑":5,"黑板":5}}','{"分数":70,"减分项":{"垃圾桶":10,"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ("大数据201",8,7,'{"分数":80,"减分项":{"纸屑":10,"黑板":10}}','{"分数":80,"减分项":{"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}'),
  ("大数据201",8,7,'{"分数":90,"减分项":{"纸屑":5,"黑板":5}}','{"分数":70,"减分项":{"垃圾桶":10,"床铺":10,"衣物叠放":10}}','{"分数":80,"减分项":{"指甲":10,"头发":10}}','{"分数":80,"减分项":{"地面":10,"垃圾桶":10}}','{"分数":80,"减分项":{"上课打闹":10,"玩手机":10}}');
