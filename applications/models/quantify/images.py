...
def images_path():
    """读取数据，判断文件路径"""
    try:
        images_read(os.path.abspath('../../../../old mod/applications/models') + r'/static/images/hero-min.jpg')
        return os.path.abspath('../../../../old mod/applications/models') + r'/static/'
    except FileNotFoundError:
        images_read(os.path.abspath('../../../../old mod') + r'/static/images/hero-min.jpg')
        return os.path.abspath('../../../../old mod') + r'/static/'
